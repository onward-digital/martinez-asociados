...
import { useScrollReveal, fadeInUp, fadeInLeft, fadeInRight, scaleIn, fadeIn, staggerContainer } from '@/hooks/useScrollAnimation';
...
export default function Contact() {
  ...
  const { ref: bodyRef, inView: bodyInView } = useScrollReveal();
