...
const translations = {
  es: {
    ...
    test_1_text: 'Necesitábamos asesoramiento urgente para una fusión y el equipo de Martínez respondió con rapidez y claridad. Nos guiaron en cada paso del proceso con total profesionalismo.',
    test_1_name: 'Carlos Mendoza',
    test_1_role: 'Gerente General, Logística Sur S.A.',

    test_2_text: 'La Dra. Vega me acompañó durante todo el proceso de sucesión familiar. Su trato humano y su conocimiento hicieron que una situación difícil fuera mucho más llevadera.',
    test_2_name: 'María Elena Ríos',
    test_2_role: 'Cliente particular',

    test_3_text: 'Teníamos un conflicto contractual que se arrastraba hacía meses. El Dr. Ruiz encontró una solución que nos permitió cerrar el tema sin ir a juicio. Muy recomendables.',
  ...
  en: {
    ...
    test_1_text: 'We needed urgent legal advice for a merger and the Martínez team responded quickly and clearly. They guided us through every step with total professionalism.',
    test_1_name: 'Carlos Mendoza',
    test_1_role: 'General Manager, Logística Sur S.A.',
    test_2_text: 'Dr. Vega accompanied me throughout the family estate process. Her warmth and expertise made a difficult situation much easier to navigate.',
    test_2_name: 'María Elena Ríos',
    test_2_role: 'Private client',
    test_3_text: 'We had a contract dispute that had been dragging on for months. Dr. Ruiz found a solution that allowed us to close the matter without going to court. Highly recommended.',
    test_3_name: 'Roberto Casares',
